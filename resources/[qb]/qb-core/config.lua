...
QBCore.Config.Money = {}
QBCore.Config.Money.MoneyTypes = { cash = 100000, bank = 500000, crypto = 0 } -- Freeroam starting money
...
QBCore.Config.Player.HungerRate = 0.0 -- Disabled for freeroam
QBCore.Config.Player.ThirstRate = 0.0 -- Disabled for freeroam
