...
Config.StressChance = 0.0         -- Disabled for freeroam
Config.UseMPH = false              -- Use KMH for freeroam
Config.MinimumStress = 100        -- Minimum Stress Level For Screen Shaking
Config.MinimumSpeedUnbuckled = 999 -- Disabled
Config.MinimumSpeed = 999         -- Disabled
Config.DisableStress = true      -- Disable stress completely for freeroam
